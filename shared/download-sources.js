(function (root, factory) {
  ...
  const sources = [
    ...
    { id:'ena_raw', label:'ENA', example:'ERR164407', exampleText:'ERR164407', placeholder:'每行一个，例如 ERR164407' },
  ...
  return { sources, extras, all, byId, accessionTypes, normalizeValue, normalizeList, renderPrimaryButtons };
});
